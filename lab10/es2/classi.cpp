...
void population::genetic(double t)
{
  order();
...
void population::copy_list(int list [],int pos)
{
  for (int i=0; i<N_cities; i++)
  {
    
    pop[pos].Set(i, list[i]);
  }
...
void individuo::mutation( double t)
{
  ...
  i1.copy(*this);//copio l'individuo
