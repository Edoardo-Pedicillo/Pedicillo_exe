...
class PriceCall : public FunzioneBase
{

public:
	PriceCall ( double m_S, double m_T, double m_K, double mr, double msigma,double mtheta );
...
private:
	...
	double r ;
	double sigma ;
	double theta; //Discrimina tra push e call
};


class PriceCall2 : public FunzioneBase
{

public:
	PriceCall2 ( double m_S, double m_T, double m_K, double mr, double msigma, int nstep, double mtheta);
